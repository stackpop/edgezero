...
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Axum       | Edit the applicable `.edgezero/local-config-<id>.json` object and remove only confirmed orphan properties. Preserve every blob key the runtime may select; `config push` upserts into this file and does not recreate it from scratch.       |
