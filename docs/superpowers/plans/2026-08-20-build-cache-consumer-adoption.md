...
**Spec:** `docs/superpowers/specs/2026-08-20-edgezero-deploy-build-caching-design.md` v6.41 Sections
...
- [ ] Run independent contract and release-adversary reviews against design v6.41, including exact-tag
