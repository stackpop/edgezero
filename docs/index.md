...
features:
  ...
  - title: Fastly Compute@Edge Support
  ...
  - title: Type-Safe Extractors
    details: 'Use ergonomic extractors like Json, Path, Query, and validated variants with the #[action] macro for clean handler code'
