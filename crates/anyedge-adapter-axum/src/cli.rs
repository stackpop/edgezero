...
static AXUM_DEPENDENCIES: &[DependencySpec] = &[
    DependencySpec {
        key: "dep_anyedge_core_axum",
        repo_crate: "crates/anyedge-core",
        fallback: "anyedge-core = { git = \"ssh://git@github.com/stackpop/anyedge.git\", package = \"anyedge-core\" }",
        features: &[],
    },
    DependencySpec {
...
static AXUM_BLUEPRINT: AdapterBlueprint = AdapterBlueprint {
    ...
    dependency_crate: "anyedge-adapter-axum",
    dependency_repo_path: "crates/anyedge-adapter-axum",
    ...
    run_module: "anyedge_adapter_axum",
};
...
fn run_cargo(project: &AxumProject, subcommand: &str, extra_args: &[String]) -> Result<(), String> {
    ...
    println!(
        "[anyedge] Axum {subcommand} ({}) in {} (port: {})",
...
mod tests {
    use super::*;
    use anyedge_adapter::cli_support::find_manifest_upwards;
