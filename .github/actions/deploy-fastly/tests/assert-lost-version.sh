...
main() {
  ...
  grep -q '^fastly service resource-link list --service-id=dummyservice --version=42 --json$' "$FAKE_CALL_LOG" || fail "failure did not occur during post-upload verification"
